...
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'Seoul')">진행중인 채용정보</button>
  <button class="tablinks" onclick="openCity(event, 'London')">관심있는 채용정보</button>
  <button class="tablinks" onclick="openCity(event, 'Paris')">나의 채용정보</button>
